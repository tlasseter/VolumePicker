...
public class StsSensorClass extends StsClass implements StsSerializable, StsClassCursorDisplayable
{
	...
	public StsSensor getValueSensor()
	{
		return valueSensor;
	}
	...
	public int getAccentDuration()
	{
		return accentDuration;
	}
	...
	public boolean getEnableAccent()
	{
		return enableAccent;
	}
	...
	public StsColor getAccentColor()
	{
		return accentColor;
	}

	public String getDefaultSpectrumName()
	{
		return defaultSpectrumName;
	}
	...
	public StsColor getDefaultSensorColor()
	{
	...
	{
		return StsSensor.SYMBOL_TYPE_STRINGS[defaultPointType];
	}
	...
	public byte getDefaultPointType()
	{
		return defaultPointType;
	}

	public double getXRelativeCriteria()
	{
		return xRelativeCriteria;
	}

	public void setXRelativeCriteria(double value)
	{
		xRelativeCriteria = value;
	}

	public long getMultiStageCriteria()
	{
		return multiStageCriteria;
	}

	public void setMultiStageCriteria(long value)
	{
		multiStageCriteria = value;
	}

	public boolean canExportView()
	{
		return true;
	}
	...
	public int exportView(String filename, StsProgressPanel panel, byte type, boolean messageOut)
	{
		...
		{
			new StsMessage(currentModel.win3d, StsMessage.ERROR, "Unable to create file, check permissions.");
			return 0;
		}
		...
		if (StsYesNoDialog.questionValue(currentModel.win3d, "Do you want to create a sensor with the exported data?"))
		{
			...
			try
			{
				StsSensorImport.setCurrentDirectory(StsFile.getDirectoryFromPathname(file.getPath()));
			}
			catch (StsException ex)
			{
				System.err.println("File access error: " + ex);
			}
