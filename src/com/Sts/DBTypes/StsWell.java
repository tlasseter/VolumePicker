...
public class StsWell extends StsLine implements StsTimeEnabled, StsSelectable, StsTreeObjectI, StsMonitorable, StsViewSelectable
{
	...
	*/
	...
	public float getCurtainOffset()
	{
		return curtainOffset;
	}
...
//            StsMessageFiles.errorMessage("Can't offset vertical well: resetting curtain offset to zero");
	...
	public void setKbElev(float kbEl)
	{
		kbElev = kbEl;
	}

	public void setElev(float el)
	{
		elev = el;
	}

	public void setElevDatum(String ed)
	{
		elevDatum = ed;
	}
	...
	public void setWellNumber(String num)
	{
		wellNumber = num;
	}

	public void setWellLabel(String label)
	{
		wellLabel = label;
	}
	...
	public void setPermitDate(long permit)
	{
		this.permitDate = permit;
	}
...
//         logCurve.checkAddMDepth(this);
	...
	*/
	...
	public boolean hasLogCurves()
	{
		return logCurves != null && logCurves.getSize() > 0;
	}
