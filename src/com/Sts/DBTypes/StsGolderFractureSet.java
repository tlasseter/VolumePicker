...
public class StsGolderFractureSet extends StsBoundingBox implements StsSelectable, StsTreeObjectI, StsTimeEnabled, StsView3dDisplayable
{
	...
	static
	{
		colorActionsList = new String[]{COLOR_NONE_STRING, COLOR_SEQUENCE_STRING};
	}
...
//        }
	...
	public boolean getDisplaySectionEdges()
	{
		return displaySectionEdges;
	}
